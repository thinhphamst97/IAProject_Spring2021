			...
			<div class="content">
				<div class="container-fluid">
					...
					for (ClientDTO macDeployClient : macDeployClientList) {
						String macDeployImageName = macDeployClient.getMacDeployImage() == null
						? null
						: macDeployClient.getMacDeployImage().getName();
						out.println(macDeployClient.getId() + ": " + macDeployClient.getName() + " - " + macDeployImageName +"</br>");
					}
					%>
