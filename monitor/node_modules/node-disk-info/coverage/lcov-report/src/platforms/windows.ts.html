...
&nbsp;
                switch (section) {
                    ...
                    case 'Description':
                        ...
                        break;
                    case 'FreeSpace':
                        freeSpace = isNaN(parseFloat(data)) ? <span class="branch-0 cbranch-no" title="branch not covered" >0 </span>: +data;
                        break;
                    case 'Size':
                        size = isNaN(parseFloat(data)) ? <span class="branch-0 cbranch-no" title="branch not covered" >0 </span>: +data;
                        break;
                }
&nbsp;
            } else {
...
&nbsp;
                    let percent = '0%';
&nbsp;
                    <span class="missing-if-branch" title="else path not taken" >E</span>if (size &gt; 0) {
...
&nbsp;</pre></td></tr></table></pre>
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Tue Apr 06 2021 11:16:12 GMT-0500 (hora estándar de Colombia)
            </div>
        </div>
